...
EVERY coaching claim needs EVIDENCE: quote one exact line from the FAILING
OUTPUT in "evidence". The harness verifies the quote against the output it
showed you - a recoach or reslice without a verifiable quote is DEMOTED to a
report, because a confident wrong instruction costs a full re-drive.
