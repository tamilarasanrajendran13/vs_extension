...
class StdioTransport(Transport):
    ...
    def _request(self, method: str, params: dict) -> Any:
        # ONE lock across the whole round trip. Locking only the write lets two
        # threads interleave their readline()s - a guaranteed protocol desync
        # the moment anything (a lead with max_workers > 1) shares the
