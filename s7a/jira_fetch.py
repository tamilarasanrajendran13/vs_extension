...
def main() -> int:
    ...
    try:
        # The workbench is our parent - scripts/ lives inside it. Without this,
        # running this script standalone would ignore .local/docket-runtime.env
        # and only work if the vars happened to be exported.
